...
1. Subagent 1: description `PAR Review A: [task]`, prompt = wrapper with `[A]` substituted + reviewer instructions
2. Subagent 2: description `PAR Review B: [task]`, prompt = wrapper with `[B]` substituted + reviewer instructions
